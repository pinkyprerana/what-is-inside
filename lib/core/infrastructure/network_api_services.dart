...
class NetworkApiService implements BaseApiServices {
  ...
  @override
  Future<(dynamic, DioException?)> getApiRequestWithToken({required String url}) async {
    try {
      var headers = {
        'Accept': '*/*',
        'Content-Type': 'application/json',
        'Authorization': 'Bearer ${_hiveDatabase.box.get(AppPreferenceKeys.token)}',
  ...
  Future<(dynamic, DioException?)> postApiRequestWithToken({
    ...
    try {
      var headers = {
        ...
        /// TO DO Confirm Header for Token
      };
